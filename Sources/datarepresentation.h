...
public:
     ...
     * \pre The number of features in the point must match those in this dataset (dataPoint.size() ==
     * this->getFeatureCount()). \return The unique consecutive ID of the point.
     */
